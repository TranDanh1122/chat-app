...
const PostItem = ({ post, state, setState }: PostItemProps,): React.JSX.Element => {
    ...
    return <div className="p-3 flex h-full items-start gap-5 bg-neutral-700 rounded-xl">
        ...
        <div className="flex-1">
            ...
            <div ref={contentRef} className="relative pb-5 overflow-hidden">
                ...
                {!state.isExpand &&
                    <div className="absolute left-0 -bottom-2 bg-gradient-to-b from-black/40 to-black/80 backdrop-blur-3xl w-full flex justify-end items-center p-3">
